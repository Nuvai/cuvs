 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqIndexParamsCreate(cuvsMultiGpuIvfPqIndexParams_t* index_params);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqIndexParamsDestroy(cuvsMultiGpuIvfPqIndexParams_t index_params);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqSearchParamsCreate(cuvsMultiGpuIvfPqSearchParams_t* params);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqSearchParamsDestroy(cuvsMultiGpuIvfPqSearchParams_t params);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqIndexCreate(cuvsMultiGpuIvfPqIndex_t* index);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqIndexDestroy(cuvsMultiGpuIvfPqIndex_t index);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqSerialize(cuvsResources_t res,
                                                cuvsMultiGpuIvfPqIndex_t index,
                                                const char* filename);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqDeserialize(cuvsResources_t res,
                                                  const char* filename,
                                                  cuvsMultiGpuIvfPqIndex_t index);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsMultiGpuIvfPqDistribute(cuvsResources_t res,
                                                 const char* filename,
                                                 cuvsMultiGpuIvfPqIndex_t index);
