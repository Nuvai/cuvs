 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsIvfFlatIndexParamsCreate(cuvsIvfFlatIndexParams_t* index_params);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsIvfFlatIndexParamsDestroy(cuvsIvfFlatIndexParams_t index_params);
/**
 * @}
 */
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsIvfFlatSearchParamsCreate(cuvsIvfFlatSearchParams_t* params);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsIvfFlatSearchParamsDestroy(cuvsIvfFlatSearchParams_t params);
/**
 * @}
 */
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsIvfFlatIndexCreate(cuvsIvfFlatIndex_t* index);
 ...
 */
CUVS_API cuvsError_t cuvsIvfFlatIndexDestroy(cuvsIvfFlatIndex_t index);

/** Get the number of clusters/inverted lists */
CUVS_API cuvsError_t cuvsIvfFlatIndexGetNLists(cuvsIvfFlatIndex_t index, int64_t* n_lists);

/** Get the dimensionality of the data */
CUVS_API cuvsError_t cuvsIvfFlatIndexGetDim(cuvsIvfFlatIndex_t index, int64_t* dim);
 ...
 */
/**
 * @brief Build a IVF-Flat index with a `DLManagedTensorVersioned` which has underlying
 ...
 */
/**
 * @brief Search a IVF-Flat index with a `DLManagedTensorVersioned` which has underlying
 *        `DLDeviceType` equal to `kDLCUDA`, `kDLCUDAHost`, `kDLCUDAManaged`.
 ...
 */
CUVS_API cuvsError_t cuvsIvfFlatSerialize(cuvsResources_t res,
                                          const char* filename,
                                          cuvsIvfFlatIndex_t index);
 ...
 */
CUVS_API cuvsError_t cuvsIvfFlatDeserialize(cuvsResources_t res,
                                            const char* filename,
                                            cuvsIvfFlatIndex_t index);
/**
 * @}
