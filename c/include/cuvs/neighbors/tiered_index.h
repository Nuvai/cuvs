 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsTieredIndexCreate(cuvsTieredIndex_t* index);
 ...
 */
CUVS_API cuvsError_t cuvsTieredIndexDestroy(cuvsTieredIndex_t index);
/**
 * @}
 */
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsTieredIndexParamsCreate(cuvsTieredIndexParams_t* index_params);
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsTieredIndexParamsDestroy(cuvsTieredIndexParams_t index_params);
/**
 * @}
 */
 ...
 */
/**
 * @brief Build a TieredIndex index with a `DLManagedTensorVersioned` which has underlying
 ...
 */
/**
 * @brief Search a TieredIndex index with a `DLManagedTensorVersioned`
 *
 * @code {.c}
 * #include <cuvs/core/c_api.h>
 * #include <cuvs/neighbors/tiered_index.h>
 ...
 * @return cuvsError_t
 */
CUVS_API cuvsError_t cuvsTieredIndexMerge(cuvsResources_t res,
                                          cuvsTieredIndexParams_t index_params,
